...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  % Sottotitolo — una riga sola adesso: la seconda ("sempre aperto, anche di
  % notte") ha lasciato il posto alla pillola con l'indirizzo, spostata più
  % in alto per stare proprio li'.
  \node[anchor=north west, text=white!88!studioteal, align=left, font=\sffamily\fontsize{13}{16}\selectfont]
    at (0.7,11.55) {Ambulatori di Arceto e Casalgrande};
  ...
  ] at (\larghezza/2,10.85) {studiomedicobragliavaleria.it};

  % ---- Le cinque funzioni ---------------------------------------------------
  % "Registrati" per prima, subito sotto la pillola dell'indirizzo: e' il
  % passo prima di tutti gli altri.
  \def\riga#1#2#3{%
  ...
  \riga{7.70}{Prenota una visita}{Scegli ambulatorio, giorno e orario\\dal calendario}
  \riga{6.10}{Richiedi ricette e impegnative}{Medicinali, visite specialistiche,\\esami del sangue}
  \riga{4.50}{Ricevi un avviso}{Una notifica quando la tua\\richiesta è pronta}
  \riga{2.90}{Installa il sito come app}{Un'icona sul telefono, gratis,\\senza App Store}
  ...
  \end{scope}
  % Capsula (medicinale)
  \begin{scope}[shift={(1.15,6.10)}, rotate=45]
  ...
  \end{scope}
  % Campanella (notifica)
  \begin{scope}[shift={(1.15,4.50)}, white, line width=1.1pt, line cap=round, line join=round]
