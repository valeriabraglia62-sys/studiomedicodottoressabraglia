...
% tutto: le coordinate sotto sono già proporzionate a W e H.
\newlength{\W}\setlength{\W}{9cm}
\newlength{\H}\setlength{\H}{16cm}
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  % ---- Sfondo (crema, caldo) --------------------------------------------
  \fill[studiocrema] (0,0) rectangle (\W,\H);
  ...
  \fill[studioteal] (0,10.1) rectangle (\W,\H);

  % Croce grande, decorativa, appena visibile, in alto a destra
  \begin{scope}
    \clip (0,10.1) rectangle (\W,\H);
  ...
  ] at (\W/2,10.05) {studiomedicobragliavaleria.it};
  ...
  ] (cta) at (\W/2,1.55) {Scopri il sito \ $\rightarrow$};

  \node[anchor=north, text=studiogrigio, font=\sffamily\fontsize{10.5}{13}\selectfont]
    at (\W/2,0.85) {studiomedicobragliavaleria.it};
